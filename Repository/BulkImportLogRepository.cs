...
public class BulkImportLogRepository(DbContext dbContext) : AsyncBulkEFIdentifiableRepository<string, ImportLog>(dbContext), IBulkImportLogRepository<IReadOnlyCollection<ImportLog>>
{
