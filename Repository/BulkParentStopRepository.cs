...
public class BulkParentStopRepository(DbContext dbContext) : AsyncBulkEFIdentifiableRepository<string, ParentStop>(dbContext), IBulkParentStopRepository<IReadOnlyCollection<ParentStop>>
{
