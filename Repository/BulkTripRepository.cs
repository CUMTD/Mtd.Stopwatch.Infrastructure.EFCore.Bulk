...
public class BulkTripRepository(StopwatchContext dbContext) : AsyncBulkEFIdentifiableRepository<string, Trip>(dbContext), IBulkTripRepository<IReadOnlyCollection<Trip>>
{
