...
public class BulkRouteRepository(StopwatchContext dbContext) : AsyncBulkEFIdentifiableRepository<string, Route>(dbContext), IBulkRouteRepository<IReadOnlyCollection<Route>>
{
