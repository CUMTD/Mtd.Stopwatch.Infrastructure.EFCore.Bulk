...
public class BulkChildStopRepository(StopwatchContext dbContext) : AsyncBulkEFIdentifiableRepository<string, ChildStop>(dbContext), IBulkChildStopRepository<IReadOnlyCollection<ChildStop>>
{
