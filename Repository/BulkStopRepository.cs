...
public class BulkStopRepository(DbContext dbContext) : AsyncBulkEFIdentifiableRepository<string, Stop>(dbContext), IBulkStopRepository<Stop, IReadOnlyCollection<Stop>>
{
