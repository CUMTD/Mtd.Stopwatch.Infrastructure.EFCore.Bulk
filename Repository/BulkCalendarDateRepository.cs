...
public class BulkCalendarDateRepository(StopwatchContext dbContext) : AsyncBulkEFRepository<CalendarDate>(dbContext), IBulkCalendarDateRepository<IReadOnlyCollection<CalendarDate>>
{
